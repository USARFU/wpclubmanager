...
* Fix - Fixed postponed matches in club head to head count
...
* Fix - Fixed new players not showing in roster lists
* Fix - Fixed issue displaying Player Lists in League Mode
...
* Template - '/layout/wrapper-end.php' - Updated template
