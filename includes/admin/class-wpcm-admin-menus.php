...
class WPCM_Admin_Menus {
	...
	public function admin_menu() {
	    ...
	    $main_page = add_menu_page( __( 'Club Manager', 'wp-club-manager' ), __( 'Club Manager', 'wp-club-manager' ), 'manage_wpclubmanager', 'wpcm-dashboard' , array( $this, 'dashboard_page' ), apply_filters( 'wpcm_admin_menu_icon_url', WPCM()->plugin_url() . '/assets/images/logo.png' ), '31' );
